...
export const experiences = [
  {
    ...
    bullets: [
      "Designed, built, and deployed TamaracTV, a live municipal broadcast platform and citywide digital display network managing streaming, content scheduling, and multi-site screen infrastructure across city facilities.",
      "Served as the primary digital authority for the city, managing municipal web assets, public-facing websites, and citywide technology infrastructure.",
      "Partnered directly with the Chief Information Officer on new digital initiatives, carrying projects from concept through deployment.",
      "Managed citywide TV infrastructure, public communications systems, and digital display networks supporting mission-critical public-facing technology.",
      "Coordinated with departments, elected officials, and external vendors to deliver projects on time and within budget and compliance requirements.",
    ],
  },
  {
    id: "2",
...
export const education = [
  {
    ...
    institution: "Keiser University Online",
    year: "2021",
